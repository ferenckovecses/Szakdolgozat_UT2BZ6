...
namespace GameControll
{
	public class Skill_Controller
	{
		...
		{
            modules.GetGameModule().StartCoroutine(FirstCut_QuickEffect());
		}
		...
		private void Preach()
		{
			modules.GetGameModule().StartCoroutine(Preach_QuickEffect());
		}

		private IEnumerator Preach_QuickEffect()
		{
