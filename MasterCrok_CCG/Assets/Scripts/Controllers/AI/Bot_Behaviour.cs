...
public static class Bot_Behaviour
{
	...
	//TODO: Do the AI stuff
	public static SkillChoises ChooseSkill(int activeCardID, List<Card> cardsInHand, List<Card> cardsOnField, List<PlayerCardPairs> opponentCards, int numberOfWinners)
	{
		int choiceValue = UnityEngine.Random.Range(1,randomMaxTreshold);
